...
[s2;%% &]
[s2;%% AnsiParser can handle UTF`-8 and non UTF`-8 characters, C0 
...
[s3; &]
[s5;:Upp`:`:AnsiParser`:`:Parse`(const Upp`:`:String`&`,bool`): [@(0.0.255) void]_[* Pars
e]([@(0.0.255) const]_[_^Upp`:`:String^ String][@(0.0.255) `&]_[*@3 data], 
[@(0.0.255) bool]_[*@3 utf8])&]
[s5;:Upp`:`:AnsiParser`:`:Parse`(const void`*`,int`,bool`): [@(0.0.255) void]_[* Parse]([@(0.0.255) c
...
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WasChr`(`)const: [@(0.0.255) bool]_[* WasChr]()_[@(0.0.255) const
]&]
...
It delivers character data exclusively via either the unicode 
codepoint array (first parameter) or the ascii byte buffer (second 
parameter). The count (last parameter) specifies the number of 
available elements. This is for performance reasons. Clients 
should check which buffer is valid to select the appropriate 
processing path.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenCtl: [_^Upp`:`:Event^ Event]<[_^Upp`:`:byte^ byte]>_[* WhenCt
l]&]
[s2;%% This event is dispatched when a control byte (either in 0x00`-0x7F 
range or in 0x80`-0x9F range) is received. &]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenEsc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_AnsiParser`:
:Sequence[@(0.0.255) `&]>_[* WhenEsc]&]
[s2;%% This event is dispatched when an escape sequence is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenCsi: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_AnsiParser`:
:Sequence[@(0.0.255) `&]>_[* WhenCsi]&]
[s2;%% This event is dispatched when a control function is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenDcs: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_AnsiParser`:
:Sequence[@(0.0.255) `&]>_[* WhenDcs]&]
[s2;%% This event is dispatched when a device control string is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenOsc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_AnsiParser`:
:Sequence[@(0.0.255) `&]>_[* WhenOsc]&]
[s2;%% This event is dispatched when an operating system command 
is received.&]
[s3;%% &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:WhenApc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_AnsiParser`:
...
depending on the AnsiParser context.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:type: [_^Upp`:`:byte^ byte]_[* type]&]
[s2;%% Represents the type of the sequence. Currently the valid values 
are ESC, CSI, DCS, OSC, and APC.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:opcode: [_^Upp`:`:byte^ byte]_[* opcode]&]
[s2;%% Also known as the `"final`" or `"terminator`" byte. Usually 
represents the opcode of received function.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:mode: [_^Upp`:`:byte^ byte]_[* mode]&]
...
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:intermediate: [_^Upp`:`:byte^ byte]_[* intermediate
][@(0.0.255) `[][@3 4][@(0.0.255) `]]&]
...
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:GetInt`(int`,int`)const: [@(0.0.255) int]_[* GetInt
...
[s3;%% &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:GetStr`(int`)const: [_^Upp`:`:String^ String]_[* Ge
...
[s3;%% &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:ToString`(`)const: [_^Upp`:`:String^ String]_[* ToS
tring]()_[@(0.0.255) const]&]
[s2;%% Returns the sequence as a String. Useful for diagnostics and 
logging.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:AnsiParser`:`:Sequence`:`:GetHashValue`(`)const: [_^Upp`:`:dword^ dword]_[* G
