...
[s3;%- &]
[s4;%- &]
[s5;:Upp`:`:TerminalCtrl`:`:SetBrightness`(int`):%- TerminalCtrl[@(0.0.255) `&] 
[* SetBrightness]([@(0.0.255) int] [*@3 level])&]
[s2; Sets the brightness of terminal display to [%-*@3 level]. The 
level can be in 0`-100 range. Returns `*this for method chaining.&]
[s3;%- &]
[s4;%- &]
[s5;:Upp`:`:TerminalCtrl`:`:GetBrightness`(`)const:%- [@(0.0.255) int] 
[* GetBrightness]() [@(0.0.255) const]&]
[s2; Returns the current brightness level of terminal display.&]
[s3;%- &]
[s4;%- &]
...
[s3;%- &]
[s4;%- &]
[s5;:Upp`:`:TerminalCtrl`:`:FlashDisplay`(int`):%- [@(0.0.255) void] 
[* FlashDisplay]([@(0.0.255) int] [*@3 ms] [@(0.0.255) `=] [@3 100])&]
...
henBell ]for event notification. Duration of the flash can be 
in given [%-*@3 ms] (miliseconds).&]
[s3;%- &]
[s4;%- &]
